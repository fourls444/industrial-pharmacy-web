        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <div className={styles.leftColumn}>
                    <img src="/images/contact and location/location.png" alt="Pharmacist" className={styles.mainImage} />
                    <div className={styles.leftText}>
                        <h3>วิทยาลัยเภสัชอุตสาหการ<br />แห่งประเทศไทย</h3>
                        <p>ศูนย์กลางองค์ความรู้และผู้เชี่ยวชาญด้านเภสัชกรรมอุตสาหการ<br></br>ที่มุ่งยกระดับมาตรฐานวิชาชีพและอุตสาหกรรมยาไทยสู่สากล</p>
                    </div>
                </div>
